...
#define STRING_CONFIG_H_AUTHOR "(RevarBat, Snappy config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Snappy3"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // Snappy
  #define DEFAULT_Kp 29.42
  #define DEFAULT_Ki 1.81
  #define DEFAULT_Kd 119.36
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 400, 96 }
